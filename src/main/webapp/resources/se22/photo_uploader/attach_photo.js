    ...
    function html5Upload() {	
    	...
    	sUploadURL= '/billy/resources/se2/photo_uploader/upload.jsp'; 	//upload URL
	...
	function onAjaxError (){
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 			...
 			sUrl : '/billy/resources/se2/photo-uploader/upload.jsp',
 			sCallback : '/billy/resources/se2/photo-uploader/callback.html',
