...
//    	sUploadURL= 'file_uploader_html5.php'; 	//upload URL
    	...
    	sUploadURL= '/billy/resources/SE2/file_uploader_html5.jsp'; 	//upload URL
...
// 			sUrl  : location.href.replace(/\/[^\/]*$/, '') + '/file_uploader.jsp',	//샘플 URL입니다.
 			...
 			sUrl : '/billy/resources/SE2/fileUploader.jsp',
 			//sCallback : location.href.replace(/\/[^\/]*$/, '') + '/callback.html',	//업로드 이후에 iframe이 redirect될 콜백페이지의 주소
 	    	sCallback : '/billy/resources/SE2/photo_uploader/popup/callback.html',
