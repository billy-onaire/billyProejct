                        ...
                        <nav aria-label="navigation">
                            <ul class="pagination justify-content-end mt-50">
                            		<li class='page-item' id='page-prev'>
                            			<a class="page-link" href="<c:url value="delList.do?page=${pageMakerMms.startPage-1 }"/>"><i class="fa fa-chevron-left"></i></a>
                            		</li>
                            	<c:forEach begin="${pageMakerMms.startPage }" end="${pageMakerMms.endPage }" var="idx">
                            		<li class='page-item' id='page${ idx }'>
                            			<a class="page-link" href="<c:url value="delList.do?page=${idx }"/>">${idx }</a>
                            		</li>
                            	</c:forEach>
                            	<c:if test="${pageMakerMms.next }">
                            		<li class='page-item' id='page-next'>
                            			<a class='page-link' href="<c:url value="delList.do?page=${pageMakerMms.endPage+1 }"/>"><i class="fa fa-chevron-right"></i></a>
                            		</li>
                            	</c:if>
