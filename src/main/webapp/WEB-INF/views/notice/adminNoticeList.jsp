        ...
        <div class="container-fluid">
            ...
            <ul class="list-group">
                ...
                <li class="list-group-item list-group-item-action" style="height: 45px;  ">
                    <div class="notice-title" style="width: 70%; float: left;"><a href="adminnoticedetail.do?notice_no=${list.notice_no }" style="font-size: 20px;">${list.notice_title }</a></div>
                    ...
                    <div class="notice-date clearfix" style="width: 10%;  float: right;">
                        ...
                        <ul class="pagination" style="margin-left: auto;  margin-right: auto; width:100%;">
                                ...
                                <li class="page-item"><a class="page-link" href="<c:url value="adminnoticelist.do?page=${pageMaker.startPage-1 }"/>"><i class="fa fa-chevron-left"></i></a></li>
                                </c:if>
                                <c:forEach begin="${pageMaker.startPage }" end="${pageMaker.endPage }" var="idx">
                                <li class="page-item"><a class="page-link" href="<c:url value="adminnoticelist.do?page=${idx }"/>">${idx }</a></li>
                                </c:forEach>
                                <c:if test="${pageMaker.next }">
                                <li class="page-item"><a class="page-link" href="<c:url value="adminnoticelist.do?page=${pageMaker.endPage+1 }"/>"><i class="fa fa-chevron-right"></i></a></li>
                            </c:if>
                        </ul>
