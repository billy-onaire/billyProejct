...
public class sendInvoice implements Serializable{
	...
	public sendInvoice(String email, String pname, String price) {
		super();
		this.email = email;
		this.pname = pname;
		this.price = price;
	...
	public String sendInvoiceMail(String email, String pname, String price) {
		String content =
				...
				"              <div style=\"Margin-left: 20px;Margin-right: 20px;\">\r\n" + 
				"      <div style=\"mso-line-height-rule: exactly;mso-text-raise: 4px;\">\r\n" + 
				"        <p class=\"size-22\" style=\"Margin-top: 0;Margin-bottom: 20px;font-size: 18px;line-height: 26px;\" lang=\"x-size-22\"><strong><span style=\"color:#000000\">물품이름</span></strong></p>\r\n" + 
				"      </div>\r\n" + 
				"    </div>\r\n" + 
				"            \r\n" + 
				"              <div style=\"Margin-left: 20px;Margin-right: 20px;\">\r\n" + 
				"      <div style=\"mso-line-height-rule: exactly;mso-text-raise: 4px;\">\r\n" + 
				"        <p style=\"Margin-top: 0;Margin-bottom: 20px;\"><span style=\"color:#8e959c\">"+"<pre>"+ pname +"</pre>"+"</span></p>\r\n" + 
				"      </div>\r\n" + 
				"    </div>\r\n" + 
				"            \r\n" + 
				"              <div style=\"Margin-left: 20px;Margin-right: 20px;\">\r\n" + 
				...
				"              <div style=\"Margin-left: 20px;Margin-right: 20px;\">\r\n" + 
				"      <div style=\"mso-line-height-rule: exactly;mso-text-raise: 4px;\">\r\n" + 
				"        <h3 style=\"Margin-top: 0;Margin-bottom: 12px;font-style: normal;font-weight: normal;color: #281557;font-size: 18px;line-height: 26px;font-family: Avenir,sans-serif;\">가격</h3>\r\n" + 
				"      </div>\r\n" + 
				"    </div>\r\n" + 
				"            \r\n" + 
				"              <div style=\"Margin-left: 20px;Margin-right: 20px;\">\r\n" + 
				"      <div style=\"mso-line-height-rule: exactly;mso-text-raise: 4px;\">\r\n" + 
				"        <p style=\"Margin-top: 0;Margin-bottom: 20px;\">"+ price +"</p>\r\n" + 
				"      </div>\r\n" + 
				"    </div>\r\n" + 
				"            \r\n" + 
				"              <div style=\"Margin-left: 20px;Margin-right: 20px;\">\r\n" + 
				...
				"              <div style=\"Margin-left: 20px;Margin-right: 20px;\">\r\n" + 
				"      <div style=\"mso-line-height-rule: exactly;mso-text-raise: 4px;\">\r\n" + 
				"        <p style=\"Margin-top: 0;Margin-bottom: 20px;text-align: right;\">TOTAL : "+ price +"</p>\r\n" + 
				"      </div>\r\n" + 
				"    </div>\r\n" + 
				"            \r\n" + 
				"              <div style=\"Margin-left: 20px;Margin-right: 20px;\">\r\n" + 
