...
public class PageMakerMms implements java.io.Serializable{
    
    
	private static final long serialVersionUID = -8204981844175854596L;
	...
	private CriteriaMms cri;       // 앞서 생성한 Criteria를 주입받는다.
	...
	public CriteriaMms getCri() {
		return cri;
	}

	public void setCri(CriteriaMms cri) {
		this.cri = cri;
	}
