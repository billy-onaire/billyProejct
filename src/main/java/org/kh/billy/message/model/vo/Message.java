...
public class Message implements java.io.Serializable{
	...
	public Message(int mms_no, String recv_id, String sent_id, String mms_content, Date sent_date, Date read_date,
			...
			int mms_originno, int mms_groupord, int mms_grouplayer, String mms_title) {
		super();
		this.mms_no = mms_no;
	...
	public String toString() {
		return "Message [mms_no=" + mms_no + ", recv_id=" + recv_id + ", sent_id=" + sent_id + ", mms_content="
				...
				+ recv_show + ", sent_show=" + sent_show + ", mms_originno=" + mms_originno + ", mms_groupord="
				+ mms_groupord + ", mms_grouplayer=" + mms_grouplayer + ", mms_title=" + mms_title + "]";
	}
