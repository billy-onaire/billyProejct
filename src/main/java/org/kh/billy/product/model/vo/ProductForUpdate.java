...
@Component
public class ProductForUpdate implements java.io.Serializable {

	private static final long serialVersionUID = -4384465309564551104L;
	...
	public ProductForUpdate() {}

	public ProductForUpdate(int product_no, String product_name, int price, int product_quantity,
			String product_content, String progress, Date product_startdate, Date product_enddate, String weekend_yn,
			String weekday_yn, Date product_date, Date product_modifydate, String delete_yn, int category_code,
			String seller_id, int img_no, String pcategory_name, String sub_pcategory_name, String first_img,
			String second_img, String third_img, String fourth_img) {
		super();
	...
	public String toString() {
		return "ProductForUpdate [product_no=" + product_no + ", product_name=" + product_name + ", price=" + price
				...
				+ category_code + ", seller_id=" + seller_id + ", img_no=" + img_no + ", pcategory_name="
				+ pcategory_name + ", sub_pcategory_name=" + sub_pcategory_name + ", first_img=" + first_img
				+ ", second_img=" + second_img + ", third_img=" + third_img + ", fourth_img=" + fourth_img + "]";
	}
